...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeRequests() // 6
                .antMatchers("/","/login", "/signup", "/user","/register","/loginCheck","/home").permitAll() // 누구나 접근 허용
                .antMatchers("/interview-home","/interview","/interview-result").hasRole("USER") // USER, ADMIN만 접근 가능
